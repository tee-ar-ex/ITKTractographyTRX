...
if(NOT trx-cpp_FOUND)
  if(TractographyTRX_FETCH_TRX_CPP)
    ...
    # Load ITKZLIB module variables (ITKZLIB_INCLUDE_DIRS, ITKZLIB_LIBRARIES)
    # into the current scope. itk_module_load() is a macro so variables land
    # here rather than in a child scope. ITKZLIB.cmake is already generated by
    # the time this file is include()'d because ITK processes modules in
    # dependency order and ITKZLIB precedes TractographyTRX.
    itk_module_load(ITKZLIB)

    # Build libzip here, against ITK's ZLIB, and pass TRX_LIBZIP_TARGET to
    # trx-cpp so it skips its own libzip setup entirely. This keeps trx-cpp
    # free of ITK-specific knowledge about ZLIB's include layout.
    if(NOT TRX_LIBZIP_TARGET)
      # Bridge ITK's ZLIB to ZLIB::ZLIB for libzip's find_package(ZLIB REQUIRED).
      ...
      if(NOT libzip_FOUND)
        message(STATUS "TractographyTRX: libzip not found; fetching v1.11.4")
      ...
      elseif(TARGET zip)
        ...
        message(FATAL_ERROR "TractographyTRX: no suitable libzip target found.")
      endif()
    endif()
